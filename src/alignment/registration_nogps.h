#ifndef _Registration_NOGPS_
#define _Registration_NOGPS_
#pragma once
...
class RegistrationNoGPS
{
public:
	RegistrationNoGPS();

	~RegistrationNoGPS(void);
	...
	void SateBuildingSegmentation(cv::Mat &mask_building, std::vector<std::vector<Eigen::Vector2d>>& segments);

	void GlobalAlignment(std::vector<std::vector<Eigen::Vector2d>> src_list, std::vector<std::vector<Eigen::Vector2d>> dst_list, std::vector<cv::Vec6d> &trans_list);

	void HypothesesViaBuildingMatching(std::vector<std::vector<Eigen::Vector2d>> &src_list, std::vector<std::vector<Eigen::Vector2d>> &dst_list);

	void HypothesesFiltering(std::vector<std::vector<Eigen::Vector2d>> &src_list, std::vector<std::vector<Eigen::Vector2d>> &dst_list, std::vector<cv::Vec6f> &trans);
	...
	void CostTransformations(std::vector<std::vector<Eigen::Vector2d>> &src_list, std::vector<std::vector<Eigen::Vector2d>> &dst_list, 
